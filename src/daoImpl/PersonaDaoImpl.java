...
public class PersonaDaoImpl implements PersonaDao {
	...
	public boolean delete(Persona persona) {
	   ...
	   public List<Persona> obtenerPersonas() {
	       ...
	       String query = "SELECT Dni, Nombre, Apellido FROM personas";  // Asegúrate de que esta tabla existe
	       Connection cn = null;
	       ...
	       try {
	           ...
	           System.out.println("Personas cargadas: " + personas.size()); // Verifica cuántas personas se cargaron
	       } catch (SQLException e) {
	           e.printStackTrace();
	       } finally {
	           try {
